...
public class Form_Publication_Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_publication_details);
        ...
        Status1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked)
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Form_Publication_Details.this);
                    builder.setCancelable(true);
                    builder.setTitle("Status changed!");
                    builder.setMessage("Publication status will be set as PUBLISHED if you select OK.");
                ...
                if(!isChecked){
                    ...
                    builder.setCancelable(true);
                    builder.setTitle("Status changed!");
                    builder.setMessage("Publication status will be set as NOT PUBLISHED if you select OK.");
...
//                            switchPopUp.setVisibility(View.INVISIBLE);
        ...
        SubmitSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Form_Publication_Details.this,"Details Saved!",Toast.LENGTH_SHORT).show();
            }
        });
    }
}